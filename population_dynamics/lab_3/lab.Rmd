...
1. To determine the best growth model for each population and estimate L_∞, t_0, and k;
...
## 8. Calculate the ∆AIC for all the models you trialed (report your AIC table to answer questions 6, 7, and 8). 
...
### Across scenarios, which had the biggest impact on L_∞? on k? on t_0? 
