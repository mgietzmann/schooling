...
# count the number of fish in each centimeter group
# and summarize by the gear type
with(
    catch, {
        table(Gear, floor(TL / 10))
    }
)

# plot the number of fish in each centimeter group
# and split by gear type
with(
    catch, {
        hist(
            TL[Gear == 'trapnet'],
